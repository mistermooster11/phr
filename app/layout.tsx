...
const localBusinessSchema = {
  ...
  geo: { "@type": "GeoCoordinates", latitude: 40.7051, longitude: -73.6751 },
  areaServed: [
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body>
        <PageTransition />
        <SalePopup businessName="Professional Home Remodeling Inc." expiryDate="June 20, 2026" trade="remodeling contractors" />
        <Header />
        <main>{children}</main>
        <Footer />
      </body>
