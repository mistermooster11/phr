      ...
      <div className="fleet-section__container">
        ...
        <div className="fleet-section__text">
          ...
          <p className="fleet-section__intro">
            ...
            skilled crews to handle every project — from kitchen remodels to
            roofing, siding, masonry, and emergency repairs. We serve the full
            faster response times, precise service execution, and reliable results across
            New York metro area — Queens, Brooklyn, Nassau, Suffolk, the Bronx, and Westchester.
          </p>
        </div>
        ...
        <div className="fleet-section__images">
          <Image
            ...
            alt="PHR kitchen remodeling project"
            width={1024}
            height={909}
          ...
          <Image
            ...
            alt="PHR roofing and siding project"
            width={1024}
            height={683}
            className="fleet-section__img"
          />
