...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    "Free written estimates — 7 days a week",
    "Licensed in NYC, Nassau, Suffolk & Westchester",
    "40+ years of home remodeling experience",
    "Serving Queens, Brooklyn, Nassau & Suffolk",
  ];
  const WHY_RIGHT = [
    "GAF Certified roofing installations",
    "Emergency repairs — we respond fast",
    "Deal directly with the owner",
    "A+ BBB Rating — reputation built on referrals",
  ];
    ...
    <section className="cta-form" ref={sectionRef}>
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          <div className="cta-form__eyebrow hidden md:block">Free — No Obligation</div>
          ...
          <p className="cta-form__subtext hidden md:block">
            Free estimates — no obligation. Call (516) 636-5300 for Nassau &amp; Suffolk,
            <br />or (718) 316-9221 for NYC &amp; Westchester.
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            Professional home remodeling across
            Queens, Brooklyn, Nassau, Suffolk, the Bronx, and Westchester. Free written estimates — no obligation.
          </p>
          <p className="cta-form__text">
