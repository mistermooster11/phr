      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            Homeowners across Queens, Brooklyn, Nassau, Suffolk, and Westchester trust
            Professional Home Remodeling Inc. for quality craftsmanship, honest pricing,
            and work that stands behind its reputation for over 40 years.
          </p>
        </div>
